...
export class MCPClient {
   ...
   * This will trigger WDA startup if not already running
   */
   ...
   * Uses AppleScript to click the Simulator window at screen coordinates
   * This works for React Native apps without proper accessibility props
   */
